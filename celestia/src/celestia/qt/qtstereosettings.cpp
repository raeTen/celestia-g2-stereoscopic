...
const char* sliderlabellist[] = {"Stereo Mode","Stereo Depth","BackPlane relief","FooBar",NULL};
const char* checkboxlabellist[] = {"Inverted Stereo","Simple settings",NULL};
...
{
    //TODO while ui is visible, core (shifted) keys belonging to stereo should be ignored
    //or implement feedback from core to ui values
